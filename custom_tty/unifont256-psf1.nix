...
# Mapping for Japanese extended sound mark (Chōonpu) to Em Dash
		U+30FC U+2014  # ー → — (Chōonpu to Em Dash)

# Mapping for Wave Dash to Tilde
		U+301C U+007E  # 〜 → ~ (Wave Dash to Tilde)
